...
- Estrutura completa da página inicial do Finans  
- Layout responsivo adaptado para diferentes dispositivos  
- Utilização de componentes do Bootstrap com personalização  
- Exercício prático de design e desenvolvimento web  
...
git clone https://github.com/DanielleKrsitina/finans-projeto-bootstrap.git
